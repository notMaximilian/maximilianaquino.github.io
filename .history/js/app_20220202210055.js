...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'about', (WINDOW_WIDTH / 2) - 250, (WINDOW_HEIGHT - 800), 'img/card1.png', 400);
    ...
    createHeader($container, 'more', (WINDOW_WIDTH / 2) + 100, (WINDOW_HEIGHT - 800), 'img/card4.png', 200);
  }
