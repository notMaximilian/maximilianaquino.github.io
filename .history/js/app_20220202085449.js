...
function rand(min, max) {
  ...
  function updateRocket(dt, $container) {
    ...
    if (WINDOW_STATE.spacePressed && WINDOW_STATE.rocketCooldown <= 0) {
      createLaser($container, WINDOW_STATE.rocketX + 26, WINDOW_STATE.rocketY-20);
    ...
    setPosition(rocket, WINDOW_STATE.rocketX, GAME_STATE.rocketY);
  }
  ...
  function createHeaderLaser($container, x, y) {
    const $element = document.createElement("img");
    $element.src = "img/laser-red-5.png";z
