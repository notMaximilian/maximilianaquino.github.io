...
const coords = [
    {name: 'about', x: (WINDOW_WIDTH / 2) , y: (WINDOW_HEIGHT - 580)},
    {name: 'projects', x : (WINDOW_WIDTH / 2) - 650 , y: (WINDOW_HEIGHT - 580)},
    {name: 'courses', x: (WINDOW_WIDTH / 2) + 300, y: (WINDOW_HEIGHT - 580)},
    {name: 'more', x: (WINDOW_WIDTH / 2) - 300, y:(WINDOW_HEIGHT - 580)}
]
...
function rand(min, max) {
  ...
  function createHeader($container, name, x, y) {
  ...
  function init() {
    ...
    createHeader($container, 'about', (WINDOW_WIDTH / 2), (WINDOW_HEIGHT - 580));
    createHeader($container, 'project', (WINDOW_WIDTH / 2) - 650, (WINDOW_HEIGHT - 580));
    createHeader($container, 'courses', (WINDOW_WIDTH / 2) + 300, (WINDOW_HEIGHT - 580));
    createHeader($container, 'more', (WINDOW_WIDTH / 2) - 300, (WINDOW_HEIGHT - 580));
