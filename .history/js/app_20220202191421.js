...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'courses', (WINDOW_WIDTH / 2) + 300, (WINDOW_HEIGHT - 800), 'img/card5.png', 200);
    createHeader($container, 'more', (WINDOW_WIDTH / 2) - 930, (WINDOW_HEIGHT - 800), 'img/card4.png', 200);
  }
