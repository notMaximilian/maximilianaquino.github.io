...
function createHeader($container, name, x, y, i, size) {
  ...
  function init() {
    ...
    createHeader($container, 'about', 10 -2.5, 18, 'img/card1.png', 23);
    createHeader($container, 'skills', 10 -2.5, 19.5, 'img/card5.png', 10);
    createHeader($container, 'more', 10 -2.5, 19.5, 'img/card4.png', 10);
  }
