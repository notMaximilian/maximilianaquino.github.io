...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'project', ((WINDOW_WIDTH / 2) - 620) + 30, (WINDOW_HEIGHT - 785), 'img/card2.png', 300);
    createHeader($container, 'skills', ((WINDOW_WIDTH / 2) - 930) + 30, (WINDOW_HEIGHT - 785), 'img/card5.png', 180);
