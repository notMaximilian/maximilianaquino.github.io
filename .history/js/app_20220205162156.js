...
function updateRocket(dt, $container) {
  ...
  function destroyHeader($container, header) {
    console.log(`Attempting to remove ${header.name} from ${$container}`)
...
function createHeader($container, $element) {
  ...
  function init() {
    ...
    createHeader($container, document.getElementById('about'),name);
    createHeader($container, document.getElementById('projects'),name);
    createHeader($container, document.getElementById('experience'),name);
    createHeader($container, document.getElementById('more'),name);
  }
