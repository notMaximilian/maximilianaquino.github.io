...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'about', ((WINDOW_WIDTH / 2) - 230) + 60, (WINDOW_HEIGHT - 800), 'img/card1.png', 400);
    createHeader($container, 'project', ((WINDOW_WIDTH / 2) - 620) + 60, (WINDOW_HEIGHT - 785), 'img/card2.png', 300);
    createHeader($container, 'skills', ((WINDOW_WIDTH / 2) - 930) + 60, (WINDOW_HEIGHT - 785), 'img/card5.png', 180);
    createHeader($container, 'more', ((WINDOW_WIDTH / 2) + 290) + 06, (WINDOW_HEIGHT - 800), 'img/card4.png', 200);
  }
