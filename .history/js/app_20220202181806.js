...
function createRocket($container) {
    ...
    setPosition($rocket, WINDOW_STATE.rocketX , WINDOW_STATE.rocketY - 300);
    setSize($rocket, 150)
...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'about', (WINDOW_WIDTH / 2), (WINDOW_HEIGHT - 580), 'img/card1.png', 300);
    ...
    createHeader($container, 'more', (WINDOW_WIDTH / 2) - 300, (WINDOW_HEIGHT - 580), 'img/card4.png', 300);
  }
