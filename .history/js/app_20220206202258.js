...
function openTab ($container, header){
  ...
  setTimeout(()=>{
    ...
    const text =document.createTextNode('heyoiajsdfojaosdifaoisdjfoaijsdfoasdoifaosidjfoiasdfoiajsdofiasodijoaisdjoaisdjfoiajsdofijasodifaosdijoiasdjfoijasdofijaosdijoiajsdfoijaosidfoaisjdfoiajsdoifaosidjoaisjdfoiajsdofijasodijoaisdjfoaisjfoijas')
    para.appendChild(text)

    const bindMe = document.querySelector('.mainNav')
    bindMe.appendChild(para)
  },1000)
