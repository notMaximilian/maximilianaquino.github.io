...
function createHeader($container, name, x, y, i, size) {
  ...
  function init() {
    ...
    createHeader($container, 'about', ((WINDOW_WIDTH / 2) - 230) + 90, (WINDOW_HEIGHT - 800) + 200, 'img/card1.png', 400);
    createHeader($container, 'project', ((WINDOW_WIDTH / 2) - 620) + 90, (WINDOW_HEIGHT - 785) + 200, 'img/card2.png', 300);
    createHeader($container, 'skills', ((WINDOW_WIDTH / 2) - 930) + 90, (WINDOW_HEIGHT - 785) + 200, 'img/card5.png', 180);
    createHeader($container, 'more', ((WINDOW_WIDTH / 2) +  270) + 90, (WINDOW_HEIGHT - 800) + 200, 'img/card4.png', 200);
  }
