...
let rocketTest = document.querySelector("#test");
setSize(rocketTest, 100)
setPosition(rocketTest, WINDOW_STATE.rocketX - 400, WINDOW_STATE.rocketY);
...
function rand(min, max) {
  ...
  function destroyHeader($container, enemy) {
