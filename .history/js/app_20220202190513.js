...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'project', (WINDOW_WIDTH / 2) - 650, (WINDOW_HEIGHT - 800), 'img/card2.png', 300);
    createHeader($container, 'courses', (WINDOW_WIDTH / 2) + 300, (WINDOW_HEIGHT - 580), 'img/card5.png', 200);
