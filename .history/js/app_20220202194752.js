...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'project', (WINDOW_WIDTH / 2) - 650, (WINDOW_HEIGHT - 7856), 'img/card2.png', 300);
    createHeader($container, 'skills', (WINDOW_WIDTH / 2) - 900, (WINDOW_HEIGHT - 800), 'img/card5.png', 200);
