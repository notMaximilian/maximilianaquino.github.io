...
function rand(min, max) {
  ...
  function init() {
    ...
    createHeader($container, 'project', (WINDOW_WIDTH / 2) - 650, (WINDOW_HEIGHT - 785), 'img/card2.png', 300);
    createHeader($container, 'skills', (WINDOW_WIDTH / 2) - 960, (WINDOW_HEIGHT - 785), 'img/card5.png', 180);
    createHeader($container, 'more', (WINDOW_WIDTH / 2) + 270, (WINDOW_HEIGHT - 800), 'img/card4.png', 200);
  }
